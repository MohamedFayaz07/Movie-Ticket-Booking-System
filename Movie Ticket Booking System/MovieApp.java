...
public class MovieApp {
    ...
    public static void main(String[] args) {
        ...
        userobj.printSummaryBill(mvName,cinobj.getTime(),cinobj.getHall(),seats,child, mobj.childTicket, mobj.adultTicket, mobj.bill);
    }
}
...
class CinemaHalls extends Movie{
